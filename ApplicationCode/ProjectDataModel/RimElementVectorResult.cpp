...
{
    addItem( RimElementVectorResult::WHITE_GRAY_BLACK, "WHITE_GRAY_BLACK", "White, Gray, Black" );
    addItem( RimElementVectorResult::ORANGE_BLUE_WHITE, "ORANGE_BLUE_WHITE", "Orange, Blue, White" );
    addItem( RimElementVectorResult::MAGENTA_BROWN_GRAY, "MAGENTA_BROWN_GRAY", "Magenta, Brown, Gray" );
    addItem( RimElementVectorResult::RESULT_COLORS, "RESULT_COLORS", "Result Colors" );

    setDefault( RimElementVectorResult::WHITE_GRAY_BLACK );
}
